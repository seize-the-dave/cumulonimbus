...
Iam.InlinePolicy = InlinePolicy;
InlinePolicy.prototype.setPolicyName = function(name) {
  this.PolicyName = name;
};
InlinePolicy.prototype.setPolicyDocument = function(doc) {
...
AccessKey.prototype.setUserName = function(userName) {
  this.addProperty("UserName", this.simpleFilter(userName, User));
};
