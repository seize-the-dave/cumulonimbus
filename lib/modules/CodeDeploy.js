...
DeploymentGroup.prototype.setDeploymentConfigName = function(name) {
  this.addProperty("DeploymentConfigName", this.simpleFilter(name, DeploymentConfig));
};
...
function DeploymentConfig(key) {
  Resource.call(this, key, "AWS::CodeDeploy::DeploymentConfig");
}
inherits(DeploymentConfig, Resource);
CodeDeploy.DeploymentConfig = DeploymentConfig;

DeploymentConfig.prototype.setDeploymentConfigName = function(name) {
  this.addProperty("DeploymentConfigName", name);
};
DeploymentConfig.prototype.setMinimumHealthyHosts = function(hosts) {
  this.addProperty("MinimumHealthyHosts", hosts);
};
...
CodeDeploy.DeploymentConfig.MinimumHealthyHosts = MinimumHealthyHosts;

MinimumHealthyHosts.prototype.setType = function(type) {
  this.Type = type;
};
MinimumHealthyHosts.prototype.setValue = function(value) {
  this.Value = value;
};
