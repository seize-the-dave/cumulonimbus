...
Template.prototype.addCondition = function(cond) {
...
Template.prototype.toJson = function() {
  ...
  for (var i = 0; i < this.conditions.length; i++) {
    ...
    template.Conditions[condition.key] = condition.toJson();
  }
...
module.exports.TaggableResource = require("./Resource").TaggableResource;
